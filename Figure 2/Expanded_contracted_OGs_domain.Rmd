...
write.csv(result,"D:/sv2/domain_search/contracted_domain_total_zerosig.csv", row.names = F)

write.csv(domain_sig_orthogroup , "D:/sv2/domain_search/contracted_domain_OG_number.csv",row.names = F)
